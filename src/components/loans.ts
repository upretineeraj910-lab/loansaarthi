...
export const LOAN_TYPES: LoanType[] = [
  ...
  },
  {
    ...
    desc: "A secured funding solution with a reducing limit over time, paying interest only on the utilized amount.",
    rate: "from 9.25%",
    range: "up to ₹5 Cr",
    href: "/dropline-overdraft",
    icon: "💳",
    features: ["Reducing Limit", "Pay on Used Amount", "Minimal Docs"],
  },
  {
    n: "06",
